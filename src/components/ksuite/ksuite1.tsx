...
export default function KSuite1() {
  const easing: [number, number, number, number] = [0.18, 0.8, 0.3, 1];

  return (
    <section className="bg-[#F7F7F3] px-4 sm:px-6 lg:px-8">
      <motion.div
        className="mx-auto flex min-h-[85vh] max-w-7xl flex-col items-center gap-32 py-16 lg:flex-row lg:items-center lg:py-24"
      ...
      >
        ...
        >
          ...
          >
            Create and publish content <br />with real consistency
          </motion.h2>
          ...
          >
            Kompi Suite gives creators and small teams a unified place to
            produce, refine and publish content without juggling apps. Bios,
            captions, titles and formatting tools live together, helping you
            maintain a consistent voice across every channel. Instead of
            switching tabs or relying on scattered utilities, everything you
            need to write, polish and prepare posts sits in one simple
            workspace. It’s streamlined, steady, and built for teams that move
            fast with limited time.
          </motion.p>
