...
export default function KSuite2() {
    ...
    <section className="bg-[#F7F7F3] px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            Practical utilities that keep <br />everything moving
          </motion.h2>
          ...
          >
            Some parts of running an online presence aren’t glamorous, they just have to work.
            Kompi Suite wraps those small jobs into a set of dependable utilities: strong
            password generation, random numbers for giveaways, readable JSON when
            an integration misbehaves, and fresh username ideas when you are launching
            something new. They sit alongside your links, QR menus and K-Cards, so the
            boring but essential tasks live in the same space as the creative ones.
          </motion.p>
