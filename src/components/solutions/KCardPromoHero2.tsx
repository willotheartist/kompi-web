...
export function KCardPromoHero2() {
  return (
    <section
      className="
        w-full 
    ...
    >
      ...
      <div className="w-1/2 flex flex-col gap-6 z-10">
        <h1 className="text-5xl font-semibold leading-[1.05] tracking-[-0.04em] text-[#F9304B]">
          Link shortening for <br /> optimal tracking.
        </h1>

        <p className="text-lg max-w-md text-[#F9304B] leading-relaxed">
